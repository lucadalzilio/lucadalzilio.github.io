...
<img src="{{ site.baseurl }}/images/PyQuake3D.pdf" alt="PyQuake3D" style="width:100%; max-width:800px; margin-bottom: 2em;" />
...
<ul>
  <li>
    <a href="https://pyquake3d.readthedocs.io" target="_blank" rel="noopener noreferrer">
      Documentation on ReadTheDocs
    </a>
  </li>
  <li>
    <a href="https://github.com/Computational-Geophysics/PyQuake3D" target="_blank" rel="noopener noreferrer">
